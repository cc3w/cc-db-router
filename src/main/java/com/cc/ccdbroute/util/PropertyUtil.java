...
public class PropertyUtil {
    ...
    /*
    * Spring Boot 1.x中使用 RelaxedPropertyResolver 类来处理属性解析，而Spring Boot 2.x中则使用 Binder 类
    * 用于在应用程序中处理和解析属性。它可以根据属性名称的不同形式进行模糊匹配，以便更容易地获取属性的值。
    * */
    static {
        try {
